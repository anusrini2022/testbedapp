...
router.post("/reporturi", function (req, res) {
  ...
  //console.log("documenturi:"+req.body('csp-report[document-uri]'));
  //res.send("posting policy data"+ JSON.stringify(cspdir));
...
router.post("/reportto", function (req, res) {
  ...
  console.log("posting policy to reporturi");
  
  //console.log(req.body["directives"]);
...
router.post("/userdet",function(req,res){
  ...
  // router.get("/sandbox/sameorgin", function (req, res) {
  //   var dir="sameorgin";

  //   var obj = { dir: dir, csp: "", msg: "", header: "" };
